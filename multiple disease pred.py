...
diabetes_model = pickle.load(open('D:/ML/Saved models/diabetes_model.sav', 'rb'))
heart_disease_model = pickle.load(open('D:/ML/Saved Models/heartdisease.sav', 'rb'))
parkinsons_model = pickle.load(open('D:/ML/Saved Models/parkinsons.sav', 'rb'))
bmi_model = pickle.load(open('D:/ML/Saved Models/bmi_classifier.pkl', 'rb'))
bmi_scaler = pickle.load(open('D:/ML/Saved Models/scaler.pkl', 'rb'))
